...
export const reviews: Review[] = [
  {
    name: "Adeel Ahmed",
    username: "@adeelahmed",
    body: "Roman built our CarCare Pro app with Flutter and Firebase exactly to spec. The maintenance reminders and Google Maps integration work flawlessly-highly recommended!",
    img: "https://robohash.org/adeelahmed",
  },
  {
    name: "Mariam Khan",
    username: "@mariamnk",
    body: "The admin panel for the Scottish Ashna Ashri Foundation is rock-solid. Managing donations and media uploads has never been easier-excellent work, Roman!",
    img: "https://robohash.org/mariamnk",
  },
  {
    name: "Lucas Oliveira",
    username: "@lucasoliveira",
    body: "TrendTale's GPT-4 integration for content generation blew us away. The FastAPI backend and React frontend are both clean and performant.",
    img: "https://robohash.org/lucasoliveira",
  },
  {
    name: "Anna Müller",
    username: "@annamueller",
    body: "Roman's Next.js and Socket.io expertise made our AutoHub360 auctions run seamlessly. Real-time updates are smooth and reliable.",
    img: "https://robohash.org/annamueller",
  },
  {
    name: "Ahmed Siddiqui",
    username: "@ahmedsiddiqui",
    body: "Sirius.Net.Co Mailer transformed our email campaigns-bulk sends, templates, two-factor auth, and Excel import all work perfectly. Fantastic support!",
    img: "https://robohash.org/ahmedsiddiqui",
  },
  {
    name: "Priya Patel",
    username: "@priyapatel",
    body: "The Sweepstakes Admin Panel is intuitive and powerful. Role-based controls and Chart.js analytics make managing bets a breeze.",
    img: "https://robohash.org/priyapatel",
  },
  {
    name: "Yuki Nakamura",
    username: "@yukinakamura",
    body: "Ease-GPT Chrome Extension is a game-changer. Smart search, tabbed chats, and context persistence work flawlessly-couldn't ask for more.",
    img: "https://robohash.org/yukinakamura",
  },
  {
    name: "John Smith",
    username: "@johnsmith",
    body: "My personal portfolio built with Next.js and Tailwind CSS is sleek, responsive, and easy to maintain. Roman's attention to detail is top-notch.",
    img: "https://robohash.org/johnsmith",
  },
];
