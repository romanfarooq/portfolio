    ...
    <section ref={containerRef} id="experience" className="w-full scroll-mt-12">
      <div className="mt-20 min-h-screen px-5 sm:px-10 md:mt-30 lg:px-15">
        ...
        <div className="relative pb-20">
          {experiences.map((experience) => (
            ...
            >
              <aside className="flex max-w-xs flex-col items-center self-start md:sticky md:top-40 md:z-40 md:w-full md:flex-row lg:max-w-md">
                <div className="bg-midnight z-20 flex h-10 w-10 items-center justify-center rounded-full md:absolute md:-start-4">
          ...
          <div className="absolute start-5 top-0 z-10 h-full w-0.5 overflow-hidden bg-[linear-gradient(to_bottom,var(--tw-gradient-stops))] from-transparent from-0% via-neutral-700 to-transparent to-100% mask-[linear-gradient(to_bottom,transparent_0%,black_10%,black_90%,transparent_100%)] md:start-1">
            <motion.div
