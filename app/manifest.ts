...
export default function manifest(): MetadataRoute.Manifest {
  return {
    ...
    start_url: "https://romanfarooq.vercel.app/",
    display: "standalone",
    background_color: "#030412",
    theme_color: "#030412",
    orientation: "portrait-primary",
    scope: "https://romanfarooq.vercel.app/",
    lang: "en",
    categories: ["portfolio", "developer", "technology"],
    icons: [
      {
        src: "https://romanfarooq.vercel.app/favicon.ico",
        sizes: "any",
        type: "image/x-icon"
      },
      {
        src: "https://romanfarooq.vercel.app/assets/images/roman.webp",
        sizes: "1200x630",
        type: "image/webp",
        purpose: "maskable"
      }
