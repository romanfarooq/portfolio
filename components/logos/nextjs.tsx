...
export const NextJS = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    ...
    >
      ...
      <stop offset={0.465} stopColor="#2b2b2b" />
    ...
    <linearGradient
      ...
      gradientUnits="userSpaceOnUse"
    >
      <stop offset={0.377} stopColor="#fff" stopOpacity={0} />
      <stop offset={0.666} stopColor="#fff" stopOpacity={0.3} />
    ...
    <linearGradient
      ...
      gradientUnits="userSpaceOnUse"
    >
      <stop offset={0.296} stopColor="#fff" />
      <stop offset={0.521} stopColor="#fff" stopOpacity={0.5} />
      <stop offset={0.838} stopColor="#fff" stopOpacity={0} />
    </linearGradient>
    <polygon
